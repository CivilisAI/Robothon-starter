...
def write_artifacts(dataset_dir: Path, observations: list[dict], model: mujoco.MjModel, metrics: dict, weights: dict) -> None:
    ...
    challenge_evidence = {
        ...
        "judge_front_matter": [
            "The demo is a paced 68-second evidence-card run: one claim per phase, contact dots, opening badges, and a closing pass card.",
    ...
    captions = [
        (0, 8, "Twelve clinic scenarios, one generated evidence run."),
        (8, 16, "Learned vision+tactile residual policy guides the approach."),
        (16, 26, "Five tactile contacts stabilize the fragile vial."),
        (26, 38, "The cap rotates 214 degrees while the vial stays held."),
        (38, 46, "The grasp holds through a 4N shove and 9x load."),
        (46, 52, "The 500Hz tactile loop recovers slip to 0.35 mm."),
        (52, 60, "Sterile delivery, audit, blister, syringe, and dose all verify."),
        (60, 68, "Pass: 30 skills, 12 clinic scenarios, 11 criteria, 96 stress rollouts."),
    ]
    srt = []
...
paced 68-second highlight demo video.
...
1. `media/demo.mp4` - paced 68-second generated demo with one-line evidence-card overlays, dot-based five-finger contact indicator, closer grasp/cap framing, uncap highlight marker, recovered-slip marker, cap-angle arc, 4N/9x callout, opening evidence badges, and closing pass card.
...
- Presentation: paced 68-second evidence-card video plus keyframe storyboard uses one-line overlays, contact dots, closer grasp/cap framing, uncap and recovered-slip markers, opening and closing evidence cards, cap-angle arc, 4N/9x callout, and concise SRT captions.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--duration", type=float, default=68.0)
