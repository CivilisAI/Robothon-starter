...
chaptered rescue run: six short captions, six visible chapter chips, one sparse
claim per phase, dot-based five-finger contact, closer grasp/cap framing, a compact
drop-risk-to-4ms-save timeline, opening evidence badges, and a closing 100% pass card. Real-world relevance remains available as a supporting
...
| Presentation | `media/demo.mp4` is a clean 64-second rescue demo within the official 1-3 minute window. It uses six concise captions, six chapter chips, sparse one-line overlays, a dot-based five-finger contact indicator, opening badges, a closing 100% pass card, closer grasp/cap framing, an uncap marker, a compact rescue timeline, a drop-risk marker, a 4ms vial-saved marker, a cap-angle arc, and a 4N/9x disturbance callout. `media/keyframes.png` gives an eight-panel storyboard with concise subtitles, `dataset/demo_highlights.json` maps the six visible beats to judge takeaways, and `JUDGE_BRIEF.md` provides the short scoring entry point. |
...
- Clean 64-second generated rescue video with six concise captions, six chapter
  chips, sparse one-line overlays, contact dots, closer grasp/cap framing, five-finger grip,
  214-degree cap twist,
  a compact rescue timeline, drop-risk and 4ms vial-saved markers, opening evidence badges, a closing 100%
...
2. `media/demo.mp4` - generated 64-second video with six concise captions,
   sparse one-line overlays, six chapter chips, contact dots, closer grasp/cap framing, uncap,
   drop-risk-to-4ms-save timeline, and 4ms vial-saved markers, opening badges, a closing 100% pass
   card, phase labels, cap-angle arc, and 4N/9x disturbance callout.
3. `JUDGE_BRIEF.md` - short rubric mapping and numeric evidence.
4. `dataset/narrative_beats.json` and `dataset/demo_highlights.json` - video-to-rubric map for reviewers reading
...
submissions/guardian_sorter_lab/dataset/demo_highlights.json
