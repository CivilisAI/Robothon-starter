...
closed-loop slip recovery, 30/30 care-skill pass, and 96/96 stress pass.
...
machine-readable evidence pack. The regenerated demo is a concise 60-second
live-data run: one claim per phase, dot-based five-finger contact, closer
grasp/cap framing, a visible 500Hz telemetry card, uncap, drop-risk, and
grasp-saved markers. Real-world relevance remains available as a supporting
...
| Presentation | `media/demo.mp4` is a concise 60-second live-data demo within the official 1-3 minute window. It uses one-line middle overlays, a dot-based five-finger contact indicator, opening evidence cards, closer grasp/cap framing, a visible 500Hz telemetry card, an uncap completion marker, drop-risk and grasp-saved recovery markers, a cap-angle arc, and a 4N/9x disturbance callout. `media/keyframes.png` gives an eight-panel storyboard with concise subtitles, and `JUDGE_BRIEF.md` provides the short scoring entry point. |
