...
machine-readable evidence pack. The regenerated demo keeps the middle of the
video deliberately clean: one-line phase overlays, a dot-based five-finger
contact indicator, larger grasp/cap framing, opening evidence badges, and a
closing pass card. The detailed technical evidence lives in the README,
JUDGE_BRIEF, metrics, contact timeline, and stress replay.
...
pass, 214.0 degree cap rotation, 4.0 ms tactile reflex latency, 280 stable
...
| Presentation | `media/demo.mp4` is a one-minute demo within the official 1-3 minute window. It uses one-line middle overlays, a dot-based five-finger contact indicator, opening/closing evidence cards, larger motion view, a cap-angle arc, and a 4N/9x disturbance callout. `media/keyframes.png` gives an eight-panel storyboard with concise subtitles, and `JUDGE_BRIEF.md` provides the short scoring entry point. |
...
- One-minute generated demo video with concise one-line overlays, contact dots,
...
2. `media/demo.mp4` - generated one-minute video with one-line middle overlays,
