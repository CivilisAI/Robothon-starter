...
machine-readable evidence pack. The regenerated demo is a clean 60-second
...
| Presentation | `media/demo.mp4` is a clean 60-second rescue demo within the official 1-3 minute window. It uses six concise captions, sparse one-line overlays, a dot-based five-finger contact indicator, opening badges, a closing 100% pass card, closer grasp/cap framing, an uncap marker, a drop-risk marker, a 4ms vial-saved marker, a cap-angle arc, and a 4N/9x disturbance callout. `media/keyframes.png` gives an eight-panel storyboard with concise subtitles, and `JUDGE_BRIEF.md` provides the short scoring entry point. |
...
- Clean 60-second generated rescue video with six concise captions, sparse
...
2. `media/demo.mp4` - generated 60-second video with six concise captions,
